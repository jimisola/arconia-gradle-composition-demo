= Arconia Dev Services Gradle Composition Demo
:toc:
:toc-placement!:
:sectnums:

A demonstration project showcasing Spring Boot with Gradle convention plugins for automatic Redis and observability (LGTM stack) integration using Arconia Dev Services.
